...
# this also ---> audio_to_text_text_to_audio.py , modification
...
def processing():
        ...
        while True:
            try:
                ...
                with speech_recognition.Microphone() as mic:
                    ...
                    with open('human_voice.wav', 'wb') as f:
    ...
    def text_to_audio(user_say):
        ...
        try:
            ...
            #time.sleep(0.1)
            stat = audio_imo_DDN("human_voice.wav", detels=False)
            print(stat)
            ...
            print('time out Internate ping to high .. ')
