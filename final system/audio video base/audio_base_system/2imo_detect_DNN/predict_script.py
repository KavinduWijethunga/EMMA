...
for track in test_data:
    ...
    #test_file = extract_mfcc('test_data/'+track)

    test_file = extract_mfcc(file_parth + track)
    ...
    print('predict behavior - ',name_lab[np.argmax(predictions)], '  actual - ',track, '   accuressy - ',accu)
